...
The data for this map and table comes from the Annual Civil Service Employment Survey 2018, provided via the [NOMIS API](https://www.nomisweb.co.uk/). The shape files are from the ONS's [OpenGeography Portal](http://geoportal.statistics.gov.uk). This document is produced in RMarkdown using [`leaflet`](https://rstudio.github.io/leaflet/) and [`DT`](https://rstudio.github.io/DT/), and rendered using [`govdown`](https://ukgovdatascience.github.io/govdown/).
