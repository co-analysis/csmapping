...
leaflet(lad_leaf, width = 960, height = 500) %>%
...
The data for this map and table comes from the Annual Civil Service Employment Survey 2018, provided via the [NOMIS API](https://www.nomisweb.co.uk/). The shape files are from the ONS's [OpenGeography Portal](http://geoportal.statistics.gov.uk). This document is rendered in RMarkdown using [`leaflet`](https://rstudio.github.io/leaflet/) and [`DataTables`](https://rstudio.github.io/DT/). The page is rendered using [`govdown`](https://ukgovdatascience.github.io/govdown/).
