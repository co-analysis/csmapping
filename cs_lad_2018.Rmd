...
spdf_lad <- geojson_read("https://opendata.arcgis.com/datasets/2c5b8eb836c7475ba3b305106ac9dfc3_0.geojson", what = "sp")
...
lad_leaf <- sp::merge(spdf_lad, lad_dt, by.x = "lad18cd", by.y = "geo_id")
